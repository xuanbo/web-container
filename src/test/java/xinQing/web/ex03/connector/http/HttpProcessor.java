...
import xinQing.web.ex03.ServletProcessor;
import xinQing.web.ex03.StaticResourceProcessor;

/**
 * 处理连接到ServerSocket的Socket
 */
public class HttpProcessor {
    ...
    protected StringManager sm =
            StringManager.getManager("xinQing.web.ex03.connector.http");
     ...
     * 处理连接到ServerSocket的Socket
     *
     * @param socket 连接到ServerSocket的Socket
     */
